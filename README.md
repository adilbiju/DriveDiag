...
Open [http://127.0.0.1:4173](http://127.0.0.1:4173). Press `Ctrl+C` in the terminal to stop the server. To choose another port, run `PORT=4174 npm start` and open that port instead.
